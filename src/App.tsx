...
                >
                  {item}
                  <span className={absolute bottom-0 left-0 w-full h-0.5 bg-[#4285F4] transform transition-all duration-300 ${activeSection === item.toLowerCase() ? 'scale-x-100' : 'scale-x-0' &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}}></span>
                </button>
              ))}
              {/* View Resume Button */}
              <a
