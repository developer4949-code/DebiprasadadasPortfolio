...
import csicLogo from './debi_csic.png';
...
const sectionIds = ['hero', 'education', 'achievements', 'skills', 'projects', 'certifications', 'contact'] as const;
...
const projects = [
  {
    title: 'PagePilot - Premium AI RAG Knowledge Assistant',
    description: 'State-of-the-art Retrieval-Augmented Generation (RAG) chat platform with Groq LLM, Qdrant vector DB, dynamic UI, and premium dark-mode styling.',
    tech: ['RAG', 'LLM', 'iPython', 'Groq', 'Qdrant', 'LangChain'],
    image: 'https://github.com/developer4949-code/page_pilot/raw/main/assets/page_pilot_demo.gif',
    githubUrl: 'https://github.com/developer4949-code/page_pilot',
    liveUrl: 'https://huggingface.co/spaces/Developer49/page-pilot',
    impact: 'Enables seamless document ingestion and AI-driven question answering with secure session isolation.',
  },
  {
  ...
  return (
    <div className="page-shell min-h-screen overflow-x-hidden text-[#f6f0e5]">
      ...
      <main className="relative z-10">
            ...
            <Reveal className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
              ...
              <div className="grid gap-6">
                <div className="frost-card rounded-[2rem] border border-white/10 p-7">
                  ...
                  <p className="mt-4 text-4xl font-semibold text-[#f7f2e7]">8.7</p>
        ...
        {/* ─── ACHIEVEMENTS ─── */}
        <section id="achievements" className="section-space px-5 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-7xl">
            <SectionIntro
              eyebrow="Recognition"
              title="Achievements"
            ...
            <Reveal>
              <div
                className="group relative overflow-hidden rounded-[2rem] border border-[#d5b172]/20 bg-gradient-to-br from-[#0d1117] via-[#0f1620] to-[#0b1a0b] p-8 sm:p-10 shadow-[0_32px_80px_rgba(0,0,0,0.5)] transition-all duration-500 hover:border-[#d5b172]/40 hover:shadow-[0_40px_100px_rgba(1,77,1,0.25)] hover:-translate-y-2"
                style={{ backdropFilter: 'blur(24px)' }}
              >
                {/* animated bg glow */}
                <div className="pointer-events-none absolute -top-24 -right-24 h-72 w-72 rounded-full bg-[#014d01]/20 blur-[80px] transition-all duration-700 group-hover:bg-[#014d01]/40" />
                <div className="pointer-events-none absolute -bottom-16 -left-16 h-48 w-48 rounded-full bg-[#d5b172]/8 blur-[60px]" />

                {/* left accent bar */}
                <div className="absolute inset-y-0 left-0 w-1 rounded-l-[2rem] bg-gradient-to-b from-[#014d01] via-[#1a7a1a] to-transparent" />

                <div className="relative flex flex-col gap-7 sm:flex-row sm:items-start">
                  {/* Logo / Badge */}
                  <div className="flex-shrink-0">
                    <div className="flex h-20 w-20 items-center justify-center overflow-hidden rounded-[1.4rem] border border-[#1a7a1a]/40 bg-[#0a1a0a] p-3 shadow-[0_8px_32px_rgba(1,77,1,0.3)] transition-all duration-300 group-hover:shadow-[0_12px_40px_rgba(1,77,1,0.5)] group-hover:border-[#1a7a1a]/70">
                      <img src={csicLogo} alt="CSIC India" className="h-full w-full object-contain" />
                    </div>
                  </div>
                  ...
                  <div className="flex-1">
                    {/* Badge */}
                    <span className="inline-block rounded-full border border-[#1a7a1a]/50 bg-[#014d01]/30 px-4 py-1 text-xs font-semibold uppercase tracking-[0.25em] text-[#4ade80]">
                      🏆 Finalist
                    </span>

                    <h3 className="mt-4 text-2xl font-semibold leading-snug text-[#f7f2e7] sm:text-3xl">
                      Cyber Security Innovation Challenge (CSIC) 1.0
                    </h3>
                    <p className="mt-1 text-sm uppercase tracking-[0.25em] text-[#96a3bb]">DSCI India</p>

                    <p className="mt-5 text-base leading-8 text-[#aeb8cb]">
                      Finalist at CSIC 1.0 — contributing to the development of scalable full-stack solutions
                      and real-time application features in a fast-paced, high-pressure team environment.
                    </p>

                    {/* Stats row */}
                    <div className="mt-7 flex flex-wrap gap-4">
                      {[
                        { label: 'Event', value: 'CSIC 1.0' },
                        { label: 'Organizer', value: 'DSCI India' },
                        { label: 'Category', value: 'Cyber Security' },
                        { label: 'Result', value: 'Finalist' },
                      ].map(({ label, value }) => (
                        <div key={label} className="rounded-xl border border-white/10 bg-white/5 px-4 py-3 transition-all duration-300 group-hover:border-[#1a7a1a]/30 group-hover:bg-[#014d01]/10">
                          <p className="text-[0.65rem] uppercase tracking-[0.28em] text-[#96a3bb]">{label}</p>
                          <p className="mt-1 text-sm font-semibold text-[#f7f2e7]">{value}</p>
                        </div>
                      ))}
                    </div>
                  </div>
                ...
                <Reveal key={project.title}>
                  <article className="project-card h-full">
                    <div className="flex h-full flex-col p-6 sm:p-7">
                      ...
                      <div className="mt-7 pt-1 flex gap-4">
                        <a
                        ...
                        {project.liveUrl && (
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center gap-2 text-sm font-semibold uppercase tracking-[0.22em] bg-[#014d01] text-white rounded px-2 py-1 hover:bg-[#012b01]"
                          >Live Link</a>
                        )}
                      </div>
                    </div>
